...
<c:if test="${hasLevel1Pages}">
    <ul data-v-70a4be12 class="no-style">
        <c:forEach items="${level1Pages}" var="level1Page" varStatus="status">
            ...
            <c:if test="${displayLevel1Page}">
                ...
                <c:choose>
                    <c:when test="${hasLevel2Pages && recursive && page1Active}">
                        <li data-v-70a4be12 >
                            <a data-v-70a4be12 class="${page1Active? ' active' :''}" href="${page1Url}">
                                    ${page1Title}
                            </a>
                                <c:forEach items="${level2Pages}" var="level2Page" varStatus="status">
                                    ...
                                    <c:if test="${displayLevel2Page}">
                                        ...
                                        <a data-v-70a4be12 class="quaternary-nav-item  ${page2Active? ' router-link-active router-link-exact-active active' :''}"
                    ...
                    <c:otherwise>
                        <li data-v-70a4be12>
                            <a  data-v-70a4be12 class="${page1Active? ' router-link-exact-active router-link-active active' :''}" href="${page1Url}"> <span data-v-70a4be12 >${page1Title}</span></a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:if>
