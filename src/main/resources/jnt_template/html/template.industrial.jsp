...
<%--	  nacd style --%>
		<template:addResources type="css" resources="nacd.css"/>    
		<template:addResources type="css" resources="nacd.fonts.css"/>    
...
<%--	  Custom.css will win over any other css - empty by default --%>
	...
	<body>
		...
		<footer data-v-1e061012 data-v-46f65fd7 class="segment" role="contentinfo">
			<div data-v-1e061012 class="container">
