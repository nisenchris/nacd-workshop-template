...
<c:if test="${renderContext.loggedIn}">
    <button class="google-btn custom-btn-theme" disabled>
    <a class="google-btn custom-btn-theme ${cssClass}" >
            <c:if test="${not empty htmlId}"> id="${htmlId}"</c:if>
        <p class="btn-text">Hello ${user:fullName(currentUser)}</p>
    </a>
    </button>

    <button class="google-btn custom-btn-theme" href="/cms/logout">
        <a class="google-btn custom-btn-theme ${cssClass}"  href="/cms/logout">
            <c:if test="${not empty htmlId}"> id="${htmlId}"</c:if>
